...
public class Guia8Extra2 {
     ...
     * NIFService se dispondrá de los siguientes métodos: Métodos getters y
     * setters para el número de DNI y la letra. Método crearNif(): le pide al
     * usuario el DNI y con ese DNI calcula la letra que le corresponderá. Una
     * vez calculado, le asigna la letra que le corresponde según Método
     * mostrar(): que nos permita mostrar el NIF (ocho dígitos, un guion y la
